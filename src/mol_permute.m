...
function [molout] = mol_permute(molin, iorder1, iorder2, LOG=0)
%
% mol_permute - achange the order of atoms from the list in iorder1 to the
%    list in iorder2. For instance, mol_permute(mol,1:6, 6:-1:1) reverses
...
if (length(iorder1) != length(iorder2))
   error('mol_permute: input and output orders have different lengths!');
endif
