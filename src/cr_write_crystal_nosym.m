...
function cr_write_crystal_nosym(cr,file="",basisfile="",acpfile="")
% function cr_write_crystal_nosym(cr,file="",basisfile="",acpfile="")
%
% cr_write_crysatl_nosym -- write a basic crystal input file.
%
% Input:
