...
function rep = rep_setdefaultscene_meshlab(repi,t,r,lighting="3point",ifac=1,angle=45,persp=1);
% function rep = rep_setdefaultscene_meshlab(repi,t,r,lighting="3point",ifac=1,angle=45,persp=1);
%
% rep_setdefaultscene - given a representation, set up the camera
% using meshlab's positioning method, lights and background colors with 
% reasonable default parameters.
%
% Input variables:
% repi: input representation.
% r: optional camangle vector (1x3) for use with rep_addcamera_meshlab.
...
% rep: output representation.
  ...
  rep = rep_addcamera_meshlab(rep,t,r,angle,persp);
